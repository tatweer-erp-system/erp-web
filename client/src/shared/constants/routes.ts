...
export const ROUTES = {
  ...
  CUSTOMER_CREATE: "/all-customers/create",
  customerDetail: (id: string) => `/all-customers/${id}` as const,
  VENDOR_DETAILS: "/vendor-details",
  vendorDetail: (id: string) => `/all-vendors/${id}` as const,
  ...
  PRICELIST_CREATE: "/pricelists/create",
  pricelistDetail: (id: string) => `/pricelists/${id}` as const,
  USERS: "/users",
