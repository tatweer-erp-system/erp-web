...
const TYPE_CFG: Record<NotifType, { icon: React.ReactNode; color: string; label: string }> = {
  success: { icon: <CheckCircleOutlined />, color: "#10B981", label: "Success" },
...
const MODULES: NotifModule[] = ["Orders", "Inventory", "Finance", "HR", "POS", "System"];
...
export default function Notifications() {
  ...
  const { items, markRead, markAllRead, remove, clearAll } = useNotificationsStore();
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
        ...
        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", flexWrap: "wrap", gap: 12 }}>
          <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
            ...
            <div>
              <div style={{ fontSize: 18, fontWeight: 800, color: token.colorText, lineHeight: 1.2 }}>
                Notifications
              </div>
            ...
            <Col xs={12} sm={6} key={t.type}>
              <Card
                style={{
                  ...
                  cursor: "pointer",
                  outline: typeFilter === t.type ? `2px solid ${t.color}` : "none",
                }}
              ...
              >
                <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
                  ...
                  <div>
                    ...
                    <div style={{ fontSize: 11, color: token.colorTextSecondary }}>{t.label}</div>
                  </div>
                </div>
              </Card>
            </Col>
        ...
        >
          ...
          {filtered.length === 0 ? (
            ...
            <Table<Notification>
              ...
              onRow={(n) => ({
                style: {
                  background: n.read ? "transparent" : `${TYPE_CFG[n.type].color}05`,
                  cursor: "default",
                },
              })}
