...
export default function Invoice() {
  ...
  const invoiceItems = [
    {
      description: 'Laptop Pro 15" - Silver',
      qty: 2,
      unitPrice: "$1,299",
      amount: "$2,598",
    },
    ...
    <DashboardLayout currentPage="Invoice" breadcrumbs={breadcrumbs}>
      <div className="space-y-6">
        ...
        <Card className="dark:bg-card bg-card shadow-sm border-0 p-12">
          {/* Header Section */}
          <div
            className={`flex justify-between items-start mb-12 pb-8 border-b-2 border-border`}
          >
            <div className={isRTL ? "text-right" : ""}>
            ...
            <table className="w-full">
              <thead>
                <tr className="border-b-2 border-border">
                  <th
                    className={`px-4 py-3 text-left text-sm font-semibold text-foreground ${isRTL ? "text-right" : ""}`}
                  >
                    Description
                  </th>
                  <th
                  ...
                  <th
                    className={`px-4 py-3 text-right text-sm font-semibold text-foreground ${isRTL ? "text-left" : ""}`}
                  >
                    Unit Price
                  </th>
                  <th
              ...
              <tbody>
                {invoiceItems.map((item, idx) => (
                  ...
                  >
                    <td
                      className={`px-4 py-4 text-sm text-foreground ${isRTL ? "text-right" : ""}`}
                    >
                      {item.description}
                    </td>
                    ...
                    <td
                      className={`px-4 py-4 text-sm text-foreground text-right ${isRTL ? "text-left" : ""}`}
                    >
                      {item.unitPrice}
                    </td>
                    <td
                      className={`px-4 py-4 text-sm font-semibold text-foreground text-right ${isRTL ? "text-left" : ""}`}
                    >
                      {item.amount}
                    </td>
                  </tr>
          ...
          <div className={`flex justify-end mb-12`}>
            <div className="w-80">
              ...
              <div
                className={`flex justify-between py-3 border-t-2 border-border`}
              >
          ...
          {/* Notes Section */}
          <div
            className={`border-t-2 border-border pt-8 ${isRTL ? "text-right" : ""}`}
          >
          ...
          {/* Footer */}
          <div
            className={`mt-12 pt-8 border-t border-border text-center text-xs text-muted-foreground ${isRTL ? "text-right" : ""}`}
          >
            <p>
          ...
          <div className={`flex items-center justify-between`}>
            <div className={isRTL ? "text-right" : ""}>
              ...
              <p className="text-sm text-green-700 mt-1">
                Payment of $3,117 was received on February 20, 2024
              </p>
            </div>
