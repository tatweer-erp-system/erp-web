...
export default function FinancialDashboard() {
  ...
  return (
    <DashboardLayout
      currentPage="Financial Dashboard"
    ...
    >
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <Card className="p-6 dark:bg-card bg-card shadow-sm border-0">
            <h3
              className={`font-display font-bold text-lg text-foreground mb-4 ${isRTL ? "text-right" : ""}`}
            >
              Revenue vs Expenses
            </h3>
        ...
        <Card className="p-6 dark:bg-card bg-card shadow-sm border-0">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div
              className={`p-4 bg-green-50 rounded-lg border border-green-200 ${isRTL ? "text-right" : ""}`}
            >
            ...
            <div
              className={`p-4 bg-orange-50 rounded-lg border border-orange-200 ${isRTL ? "text-right" : ""}`}
            >
            ...
            <div
              className={`p-4 bg-blue-50 rounded-lg border border-blue-200 ${isRTL ? "text-right" : ""}`}
            >
