...
import {
  ApartmentOutlined, CalendarOutlined, ClockCircleOutlined,
  DollarOutlined, IdcardOutlined, SaveOutlined, SettingOutlined,
      ...
      <Section title="HR General Settings">
        <Form layout="vertical">
          <Row gutter={[16, 0]}>
            ...
            <Col xs={24} sm={12}>
              <Form.Item label="Work Hours per Day" style={{ marginBottom: 16 }}>
                <InputNumber defaultValue={8} min={1} max={24} style={{ width: "100%" }} addonAfter="hrs" />
              </Form.Item>
            </Col>
            <Col xs={24} sm={12}>
              <Form.Item label="Employee ID Prefix" style={{ marginBottom: 16 }}>
                <Input defaultValue="EMP-" maxLength={10} />
              </Form.Item>
            </Col>
            <Col xs={24} sm={12}>
              <Form.Item label="Next Employee Number" style={{ marginBottom: 16 }}>
                <InputNumber defaultValue={1001} min={1} style={{ width: "100%" }} />
              </Form.Item>
            </Col>
            <Col xs={24} sm={12}>
              <Form.Item label="Probation Period (months)" style={{ marginBottom: 16 }}>
                <InputNumber defaultValue={3} min={0} max={12} style={{ width: "100%" }} addonAfter="months" />
              </Form.Item>
            </Col>
            <Col xs={24} sm={12}>
              <Form.Item label="Notice Period (days)" style={{ marginBottom: 16 }}>
    ...
    <>
      <Section title="Employee Management">
        <Form layout="vertical">
          <Row gutter={[16, 0]}>
            <Col xs={24} sm={12}>
              <Form.Item label="Require manager approval for new hires" style={{ marginBottom: 16 }}>
                <Switch defaultChecked />
              </Form.Item>
            </Col>
            <Col xs={24} sm={12}>
              <Form.Item label="Auto-create user account on hire" style={{ marginBottom: 16 }}>
                <Switch />
              </Form.Item>
            </Col>
            <Col xs={24} sm={12}>
              <Form.Item label="Mandatory fields" style={{ marginBottom: 16 }}>
                <Select mode="multiple" defaultValue={["name", "department", "position"]} options={[
            ...
            <Col xs={24} sm={12}>
              <Form.Item label="Enable employee self-service portal" style={{ marginBottom: 16 }}>
                <Switch defaultChecked />
              </Form.Item>
            </Col>
          </Row>
          ...
          <Row gutter={[16, 0]}>
            <Col xs={24} sm={12}>
              <Form.Item label="Attendance Method" style={{ marginBottom: 16 }}>
                <Select defaultValue="manual" options={[
            ...
            <Col xs={24} sm={12}>
              <Form.Item label="Late arrival grace period (minutes)" style={{ marginBottom: 16 }}>
                <InputNumber defaultValue={15} min={0} max={60} style={{ width: "100%" }} addonAfter="min" />
              </Form.Item>
            </Col>
            <Col xs={24} sm={12}>
              <Form.Item label="Overtime policy" style={{ marginBottom: 16 }}>
                <Select defaultValue="approval" options={[
            ...
            <Col xs={24} sm={12}>
              <Form.Item label="Overtime rate multiplier" style={{ marginBottom: 16 }}>
                <InputNumber defaultValue={1.5} min={1} step={0.25} style={{ width: "100%" }} addonAfter="x" />
              </Form.Item>
            </Col>
            <Col xs={24} sm={12}>
            ...
            <Col xs={24} sm={12}>
              <Form.Item label="Geolocation check-in required" style={{ marginBottom: 16 }}>
                <Switch />
              </Form.Item>
            </Col>
          </Row>
    ...
    <>
      <Section title="Leave Policies">
        <Form layout="vertical">
          <Row gutter={[16, 0]}>
            <Col xs={24} sm={12}>
              <Form.Item label="Annual Leave (days/year)" style={{ marginBottom: 16 }}>
                <InputNumber defaultValue={21} min={0} style={{ width: "100%" }} addonAfter="days" />
              </Form.Item>
            </Col>
            <Col xs={24} sm={12}>
              <Form.Item label="Sick Leave (days/year)" style={{ marginBottom: 16 }}>
                <InputNumber defaultValue={10} min={0} style={{ width: "100%" }} addonAfter="days" />
              </Form.Item>
            </Col>
            <Col xs={24} sm={12}>
              <Form.Item label="Leave accrual period" style={{ marginBottom: 16 }}>
                <Select defaultValue="monthly" options={[
            ...
            <Col xs={24} sm={12}>
              <Form.Item label="Allow leave carryover" style={{ marginBottom: 16 }}>
                <Switch defaultChecked />
              </Form.Item>
            </Col>
            <Col xs={24} sm={12}>
              <Form.Item label="Max carryover days" style={{ marginBottom: 16 }}>
                <InputNumber defaultValue={10} min={0} style={{ width: "100%" }} addonAfter="days" />
              </Form.Item>
            </Col>
            <Col xs={24} sm={12}>
              <Form.Item label="Minimum notice for leave request (days)" style={{ marginBottom: 16 }}>
                <InputNumber defaultValue={3} min={0} style={{ width: "100%" }} addonAfter="days" />
              </Form.Item>
            </Col>
            <Col xs={24} sm={12}>
              <Form.Item label="Require manager approval for leave" style={{ marginBottom: 16 }}>
                <Switch defaultChecked />
              </Form.Item>
            </Col>
            <Col xs={24} sm={12}>
              <Form.Item label="Allow negative leave balance" style={{ marginBottom: 16 }}>
                <Switch />
              </Form.Item>
            </Col>
          </Row>
          ...
          <Row gutter={[16, 0]}>
            ...
            <Col xs={24} sm={12}>
              <Form.Item label="Pay Day" style={{ marginBottom: 16 }}>
                <Select defaultValue="last" options={[
            ...
            <Col xs={24} sm={12}>
              <Form.Item label="Income Tax Calculation" style={{ marginBottom: 16 }}>
            ...
            <Col xs={24} sm={12}>
              <Form.Item label="Social Insurance (%)" style={{ marginBottom: 16 }}>
                <InputNumber defaultValue={14} min={0} max={100} style={{ width: "100%" }} addonAfter="%" />
              </Form.Item>
            </Col>
            <Col xs={24} sm={12}>
              <Form.Item label="Require payroll approval" style={{ marginBottom: 16 }}>
                <Switch defaultChecked />
              </Form.Item>
            </Col>
          </Row>
    ...
    <>
      <Section title="Department Settings">
        <Form layout="vertical">
          <Row gutter={[16, 0]}>
            <Col xs={24} sm={12}>
              <Form.Item label="Require department for all employees" style={{ marginBottom: 16 }}>
                <Switch defaultChecked />
              </Form.Item>
            </Col>
            <Col xs={24} sm={12}>
              <Form.Item label="Require department head" style={{ marginBottom: 16 }}>
                <Switch defaultChecked />
              </Form.Item>
            </Col>
            <Col xs={24} sm={12}>
              <Form.Item label="Department budget tracking" style={{ marginBottom: 16 }}>
                <Switch />
              </Form.Item>
            </Col>
            <Col xs={24} sm={12}>
              <Form.Item label="Cost center per department" style={{ marginBottom: 16 }}>
                <Switch defaultChecked />
              </Form.Item>
            </Col>
          </Row>
          ...
          <Row gutter={[16, 0]}>
            <Col xs={24} sm={12}>
              <Form.Item label="Review Cycle" style={{ marginBottom: 16 }}>
                <Select defaultValue="annually" options={[
                  { value: "monthly",   label: "Monthly" },
                  { value: "quarterly", label: "Quarterly" },
            ...
            <Col xs={24} sm={12}>
              <Form.Item label="Enable 360° feedback" style={{ marginBottom: 16 }}>
                <Switch />
              </Form.Item>
            </Col>
            <Col xs={24} sm={12}>
              <Form.Item label="Self-assessment required" style={{ marginBottom: 16 }}>
                <Switch defaultChecked />
              </Form.Item>
            </Col>
            <Col xs={24} sm={12}>
              <Form.Item label="Link performance to salary increment" style={{ marginBottom: 16 }}>
                <Switch />
              </Form.Item>
            </Col>
          </Row>
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
      <div style={{ display: "flex", alignItems: "center", gap: 14 }}>
        ...
        <div>
          <Title level={5} style={{ margin: 0 }}>HR Settings</Title>
          <Text type="secondary" style={{ fontSize: 12 }}>Configure employees, attendance, leave, payroll, and performance</Text>
        </div>
      </div>
