...
import {
  BarChartOutlined, CalendarOutlined, CloudDownloadOutlined,
  FileTextOutlined, MailOutlined, PrinterOutlined, SaveOutlined, SettingOutlined,
    ...
    <>
      <Section title="Report Defaults">
        <Form layout="vertical">
          <Row gutter={[16, 0]}>
            <Col xs={24} sm={12}>
              <Form.Item label="Default Date Range" style={{ marginBottom: 16 }}>
                <Select defaultValue="thisMonth" options={[
            ...
            <Col xs={24} sm={12}>
              <Form.Item label="Default Comparison Period" style={{ marginBottom: 16 }}>
                <Select defaultValue="lastYear" options={[
            ...
            <Col xs={24} sm={12}>
              <Form.Item label="Default Currency" style={{ marginBottom: 16 }}>
                <Select defaultValue="functional" options={[
            ...
            <Col xs={24} sm={12}>
              <Form.Item label="Number of decimal places" style={{ marginBottom: 16 }}>
                <Select defaultValue="2" options={[
            ...
            <Col xs={24} sm={12}>
              <Form.Item label="Show zero-value rows" style={{ marginBottom: 16 }}>
                <Switch />
              </Form.Item>
            </Col>
            <Col xs={24} sm={12}>
              <Form.Item label="Auto-refresh report data" style={{ marginBottom: 16 }}>
    ...
    <>
      <Section title="Chart & Visual Settings">
        <Form layout="vertical">
          <Row gutter={[16, 0]}>
            <Col xs={24} sm={12}>
              <Form.Item label="Default Chart Type" style={{ marginBottom: 16 }}>
                <Select defaultValue="bar" options={[
            ...
            <Col xs={24} sm={12}>
              <Form.Item label="Show charts by default" style={{ marginBottom: 16 }}>
                <Switch defaultChecked />
              </Form.Item>
            </Col>
            <Col xs={24} sm={12}>
              <Form.Item label="Enable data labels on charts" style={{ marginBottom: 16 }}>
                <Switch defaultChecked />
              </Form.Item>
            </Col>
            <Col xs={24} sm={12}>
              <Form.Item label="Rows per page (tables)" style={{ marginBottom: 16 }}>
    ...
    <>
      <Section title="Automated Report Generation">
        <Form layout="vertical">
          <Row gutter={[16, 0]}>
            <Col xs={24} sm={12}>
              <Form.Item label="Enable scheduled reports" style={{ marginBottom: 16 }}>
                <Switch defaultChecked />
              </Form.Item>
            </Col>
            <Col xs={24} sm={12}>
              <Form.Item label="Daily report time" style={{ marginBottom: 16 }}>
                <Select defaultValue="08:00" options={Array.from({ length: 24 }, (_, i) => ({
            ...
            <Col xs={24} sm={12}>
              <Form.Item label="Weekly report day" style={{ marginBottom: 16 }}>
                <Select defaultValue="monday" options={[
            ...
            <Col xs={24} sm={12}>
              <Form.Item label="Monthly report date" style={{ marginBottom: 16 }}>
                <Select defaultValue="1" options={Array.from({ length: 28 }, (_, i) => ({
                  value: String(i + 1),
    ...
    <>
      <Section title="Export Configuration">
        <Form layout="vertical">
          <Row gutter={[16, 0]}>
            <Col xs={24} sm={12}>
              <Form.Item label="Default Export Format" style={{ marginBottom: 16 }}>
                <Select defaultValue="xlsx" options={[
            ...
            <Col xs={24} sm={12}>
              <Form.Item label="Include header row in exports" style={{ marginBottom: 16 }}>
                <Switch defaultChecked />
              </Form.Item>
            </Col>
            <Col xs={24} sm={12}>
              <Form.Item label="Date format in exports" style={{ marginBottom: 16 }}>
            ...
            <Col xs={24} sm={12}>
              <Form.Item label="Include company logo in PDF exports" style={{ marginBottom: 16 }}>
                <Switch defaultChecked />
              </Form.Item>
            </Col>
            <Col xs={24} sm={12}>
              <Form.Item label="Compress exported files (ZIP)" style={{ marginBottom: 16 }}>
                <Switch />
              </Form.Item>
            </Col>
          </Row>
    ...
    <>
      <Section title="Email Delivery Settings">
        <Form layout="vertical">
          <Row gutter={[16, 0]}>
            <Col xs={24} sm={12}>
              <Form.Item label="Enable email delivery" style={{ marginBottom: 16 }}>
                <Switch defaultChecked />
              </Form.Item>
            </Col>
            <Col xs={24} sm={12}>
              <Form.Item label="Default recipients" style={{ marginBottom: 16 }}>
                <Select mode="tags" placeholder="Add email addresses" />
              </Form.Item>
            </Col>
            <Col xs={24} sm={12}>
              <Form.Item label="Report email subject prefix" style={{ marginBottom: 16 }}>
            ...
            <Col xs={24}>
              <Form.Item label="Email body template" style={{ marginBottom: 0 }}>
                <Input.TextArea rows={3} defaultValue="Please find the attached report. This is an automated message from the ERP system." />
              </Form.Item>
            </Col>
          </Row>
        </Form>
    ...
    <>
      <Section title="Print Configuration">
        <Form layout="vertical">
          <Row gutter={[16, 0]}>
            <Col xs={24} sm={12}>
              <Form.Item label="Default Paper Size" style={{ marginBottom: 16 }}>
                <Select defaultValue="A4" options={[
            ...
            <Col xs={24} sm={12}>
              <Form.Item label="Default Orientation" style={{ marginBottom: 16 }}>
                <Select defaultValue="portrait" options={[
            ...
            <Col xs={24} sm={12}>
              <Form.Item label="Show print date/time" style={{ marginBottom: 16 }}>
                <Switch defaultChecked />
              </Form.Item>
            </Col>
            <Col xs={24} sm={12}>
              <Form.Item label="Include company header" style={{ marginBottom: 16 }}>
                <Switch defaultChecked />
              </Form.Item>
            </Col>
            <Col xs={24} sm={12}>
              <Form.Item label="Include footer note" style={{ marginBottom: 16 }}>
                <Switch defaultChecked />
              </Form.Item>
            </Col>
          </Row>
...
function AccessTab() {
  ...
  return (
    <>
      <Alert type="info" showIcon message="Control which roles can access each report module." style={{ marginBottom: 16, fontSize: 12 }} />
      {reportModules.map((r) => (
        <Section key={r.label} title={r.label}>
          <Form layout="vertical">
            <Form.Item label="Allowed Roles" style={{ marginBottom: 0 }}>
              <Select mode="multiple" defaultValue={r.roles} options={[
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
      <div style={{ display: "flex", alignItems: "center", gap: 14 }}>
        ...
        <div>
          <Title level={5} style={{ margin: 0 }}>Reports Settings</Title>
          <Text type="secondary" style={{ fontSize: 12 }}>Configure report defaults, scheduling, export formats, and access control</Text>
        </div>
      </div>
