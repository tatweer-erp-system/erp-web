...
import {
  CalculatorOutlined, CalendarOutlined, BookOutlined, FundOutlined,
  GlobalOutlined, LockOutlined, PercentageOutlined, SaveOutlined, SettingOutlined,
    ...
    <>
      <Section title="Accounting Defaults">
        <Form layout="vertical">
          <Row gutter={[16, 0]}>
            <Col xs={24} sm={12}>
              <Form.Item label="Accounting Standard" style={{ marginBottom: 16 }}>
                <Select defaultValue="ifrs" options={[
            ...
            <Col xs={24} sm={12}>
              <Form.Item label="Functional Currency" style={{ marginBottom: 16 }}>
            ...
            <Col xs={24} sm={12}>
              <Form.Item label="Auto-post journal entries" style={{ marginBottom: 16 }}>
                <Switch />
              </Form.Item>
            </Col>
            <Col xs={24} sm={12}>
              <Form.Item label="Require narration on journal entries" style={{ marginBottom: 16 }}>
                <Switch defaultChecked />
              </Form.Item>
            </Col>
            <Col xs={24} sm={12}>
              <Form.Item label="Allow back-dated entries" style={{ marginBottom: 16 }}>
                <Switch defaultChecked />
              </Form.Item>
            </Col>
            <Col xs={24} sm={12}>
              <Form.Item label="Require approval for manual entries" style={{ marginBottom: 16 }}>
                <Switch />
              </Form.Item>
            </Col>
          </Row>
...
function AccountsTab() {
  ...
  return (
    <>
      <Alert type="info" showIcon message="These default accounts are used when no specific account is assigned to a transaction." style={{ marginBottom: 16, fontSize: 12 }} />
            ...
            {accounts.map((a) => (
              <Col xs={24} sm={12} key={a.label}>
                <Form.Item label={a.label} style={{ marginBottom: 16 }}>
                  <Select defaultValue={a.default} options={[{ value: a.default, label: a.default }]} />
                </Form.Item>
              </Col>
            ))}
          </Row>
    ...
    <>
      <Section title="Journal Entry Defaults">
        <Form layout="vertical">
          <Row gutter={[16, 0]}>
            <Col xs={24} sm={12}>
              <Form.Item label="Default Journal Type" style={{ marginBottom: 16 }}>
                <Select defaultValue="general" options={[
            ...
            <Col xs={24} sm={12}>
              <Form.Item label="Journal Entry Prefix" style={{ marginBottom: 16 }}>
                <Input defaultValue="JE-" maxLength={10} />
              </Form.Item>
            </Col>
            <Col xs={24} sm={12}>
              <Form.Item label="Next Journal Number" style={{ marginBottom: 16 }}>
                <InputNumber defaultValue={1001} min={1} style={{ width: "100%" }} />
              </Form.Item>
            </Col>
            <Col xs={24} sm={12}>
              <Form.Item label="Require balanced entries" style={{ marginBottom: 16 }}>
                <Switch defaultChecked disabled />
              </Form.Item>
            </Col>
            <Col xs={24} sm={12}>
              <Form.Item label="Allow multi-currency journals" style={{ marginBottom: 16 }}>
                <Switch defaultChecked />
              </Form.Item>
            </Col>
            <Col xs={24} sm={12}>
              <Form.Item label="Attach documents to entries" style={{ marginBottom: 16 }}>
                <Switch defaultChecked />
              </Form.Item>
            </Col>
          </Row>
    ...
    <>
      <Section title="Fiscal Year Configuration">
        <Form layout="vertical">
          <Row gutter={[16, 0]}>
            <Col xs={24} sm={12}>
              <Form.Item label="Fiscal Year Start Month" style={{ marginBottom: 16 }}>
            ...
            <Col xs={24} sm={12}>
              <Form.Item label="Fiscal Year Duration" style={{ marginBottom: 16 }}>
                <Select defaultValue="12" options={[
            ...
            <Col xs={24} sm={12}>
              <Form.Item label="Auto-create periods" style={{ marginBottom: 16 }}>
                <Switch defaultChecked />
              </Form.Item>
            </Col>
          </Row>
          ...
          <Row gutter={[16, 0]}>
            <Col xs={24} sm={12}>
              <Form.Item label="Default Tax Rate" style={{ marginBottom: 16 }}>
                <InputNumber defaultValue={15} min={0} max={100} style={{ width: "100%" }} addonAfter="%" />
              </Form.Item>
            </Col>
            <Col xs={24} sm={12}>
    ...
    <>
      <Section title="Multi-Currency Settings">
        <Form layout="vertical">
          <Row gutter={[16, 0]}>
            <Col xs={24} sm={12}>
              <Form.Item label="Enable multi-currency" style={{ marginBottom: 16 }}>
                <Switch defaultChecked />
              </Form.Item>
            </Col>
            <Col xs={24} sm={12}>
              <Form.Item label="Exchange rate source" style={{ marginBottom: 16 }}>
            ...
            <Col xs={24} sm={12}>
              <Form.Item label="Exchange rate update frequency" style={{ marginBottom: 16 }}>
            ...
            <Col xs={24} sm={12}>
              <Form.Item label="Unrealised FX gains/losses account" style={{ marginBottom: 16 }}>
                <Select defaultValue="6100" options={[
            ...
            <Col xs={24} sm={12}>
              <Form.Item label="Realised FX gains/losses account" style={{ marginBottom: 16 }}>
                <Select defaultValue="6100" options={[
                  { value: "6100", label: "6100 · FX Gain/Loss" },
    ...
    <>
      ...
      <Section title="Period Closing Rules">
        <Form layout="vertical">
          <Row gutter={[16, 0]}>
            <Col xs={24} sm={12}>
              <Form.Item label="Require approval to close period" style={{ marginBottom: 16 }}>
                <Switch defaultChecked />
              </Form.Item>
            </Col>
            <Col xs={24} sm={12}>
              <Form.Item label="Allow posting to closed periods (with override)" style={{ marginBottom: 16 }}>
                <Switch />
              </Form.Item>
            </Col>
            <Col xs={24} sm={12}>
              <Form.Item label="Closing journal type" style={{ marginBottom: 16 }}>
                <Select defaultValue="closing" options={[
            ...
            <Col xs={24} sm={12}>
              <Form.Item label="Auto-reverse adjustment entries" style={{ marginBottom: 16 }}>
                <Switch />
              </Form.Item>
            </Col>
          </Row>
      ...
      <SaveRow onSave={() => message.success("Period closing settings saved")} />
    </>
  );
}
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
      <div style={{ display: "flex", alignItems: "center", gap: 14 }}>
        ...
        <div>
          <Title level={5} style={{ margin: 0 }}>Accounting Settings</Title>
          <Text type="secondary" style={{ fontSize: 12 }}>Configure journal settings, fiscal year, tax, and closing rules</Text>
        </div>
      </div>
