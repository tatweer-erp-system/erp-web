...
import {
  DollarOutlined, FileProtectOutlined, FileTextOutlined,
  SaveOutlined, SettingOutlined, TagsOutlined, TeamOutlined, PercentageOutlined,
    ...
    <>
      <Section title="Sales Defaults">
        <Form layout="vertical">
          <Row gutter={[16, 0]}>
            <Col xs={24} sm={12}>
              <Form.Item label="Default Price List" style={{ marginBottom: 16 }}>
                <Select defaultValue="retail" options={[
            ...
            <Col xs={24} sm={12}>
              <Form.Item label="Default Salesperson" style={{ marginBottom: 16 }}>
            ...
            <Col xs={24} sm={12}>
              <Form.Item label="Sales Order Approval" style={{ marginBottom: 16 }}>
            ...
            <Col xs={24} sm={12}>
              <Form.Item label="Lock confirmed orders" style={{ marginBottom: 16 }}>
                <Switch defaultChecked />
              </Form.Item>
            </Col>
            <Col xs={24} sm={12}>
              <Form.Item label="Send order confirmation email" style={{ marginBottom: 16 }}>
                <Switch defaultChecked />
              </Form.Item>
            </Col>
          </Row>
          ...
          <Row gutter={[16, 0]}>
            <Col xs={24} sm={12}>
              <Form.Item label="Invoice Policy" style={{ marginBottom: 16 }}>
                <Select defaultValue="order" options={[
            ...
            <Col xs={24} sm={12}>
              <Form.Item label="Default Due Date (days)" style={{ marginBottom: 16 }}>
                <InputNumber defaultValue={30} min={0} style={{ width: "100%" }} addonAfter="days" />
              </Form.Item>
            </Col>
            <Col xs={24} sm={12}>
              <Form.Item label="Default Invoice Template" style={{ marginBottom: 16 }}>
            ...
            <Col xs={24} sm={12}>
              <Form.Item label="Include taxes in line total" style={{ marginBottom: 16 }}>
                <Switch defaultChecked />
              </Form.Item>
            </Col>
            <Col xs={24} sm={12}>
              <Form.Item label="Show bank details on invoice" style={{ marginBottom: 16 }}>
                <Switch defaultChecked />
              </Form.Item>
            </Col>
            <Col xs={24} sm={12}>
              <Form.Item label="Auto-send invoice on confirmation" style={{ marginBottom: 16 }}>
                <Switch />
              </Form.Item>
            </Col>
            <Col xs={24}>
              <Form.Item label="Invoice Footer Note" style={{ marginBottom: 0 }}>
                <Input.TextArea rows={2} defaultValue="Thank you for your business. Payment is due within the specified terms." />
              </Form.Item>
            </Col>
          </Row>
        </Form>
    ...
    <>
      <Section title="Customer Defaults">
        <Form layout="vertical">
          <Row gutter={[16, 0]}>
            <Col xs={24} sm={12}>
              <Form.Item label="Default Credit Limit" style={{ marginBottom: 16 }}>
                <InputNumber defaultValue={5000} min={0} style={{ width: "100%" }} addonBefore="$" />
              </Form.Item>
            </Col>
            <Col xs={24} sm={12}>
              <Form.Item label="Enforce Credit Limit" style={{ marginBottom: 16 }}>
                <Select defaultValue="warn" options={[
            ...
            <Col xs={24} sm={12}>
              <Form.Item label="Allow walk-in (no customer)" style={{ marginBottom: 16 }}>
                <Switch defaultChecked />
              </Form.Item>
            </Col>
            <Col xs={24} sm={12}>
              <Form.Item label="Require customer address on invoice" style={{ marginBottom: 16 }}>
                <Switch />
              </Form.Item>
            </Col>
          </Row>
      ...
      <Section title="Customer Portal">
        <Form layout="vertical">
          <Row gutter={[16, 0]}>
            <Col xs={24} sm={12}>
              <Form.Item label="Enable customer portal" style={{ marginBottom: 16 }}>
                <Switch />
              </Form.Item>
            </Col>
            <Col xs={24} sm={12}>
              <Form.Item label="Allow online payment" style={{ marginBottom: 16 }}>
                <Switch />
              </Form.Item>
            </Col>
          </Row>
    ...
    <>
      <Section title="Pricing Policy">
        <Form layout="vertical">
          <Row gutter={[16, 0]}>
            <Col xs={24} sm={12}>
              <Form.Item label="Price includes tax" style={{ marginBottom: 16 }}>
                <Switch />
              </Form.Item>
            </Col>
            <Col xs={24} sm={12}>
              <Form.Item label="Allow manual price override" style={{ marginBottom: 16 }}>
                <Switch defaultChecked />
              </Form.Item>
            </Col>
            <Col xs={24} sm={12}>
              <Form.Item label="Price rounding" style={{ marginBottom: 16 }}>
                <Select defaultValue="0.01" options={[
            ...
            <Col xs={24} sm={12}>
              <Form.Item label="Default Margin (%)" style={{ marginBottom: 16 }}>
                <InputNumber defaultValue={30} min={0} max={100} style={{ width: "100%" }} addonAfter="%" />
              </Form.Item>
            </Col>
          </Row>
        </Form>
      ...
      <Section title="Discounts">
        <Form layout="vertical">
          <Row gutter={[16, 0]}>
            <Col xs={24} sm={12}>
              <Form.Item label="Allow line discounts" style={{ marginBottom: 16 }}>
                <Switch defaultChecked />
              </Form.Item>
            </Col>
            <Col xs={24} sm={12}>
              <Form.Item label="Allow global discount" style={{ marginBottom: 16 }}>
                <Switch defaultChecked />
              </Form.Item>
            </Col>
            <Col xs={24} sm={12}>
              <Form.Item label="Maximum discount (%)" style={{ marginBottom: 16 }}>
                <InputNumber defaultValue={20} min={0} max={100} style={{ width: "100%" }} addonAfter="%" />
              </Form.Item>
            </Col>
            <Col xs={24} sm={12}>
              <Form.Item label="Require approval above max discount" style={{ marginBottom: 16 }}>
                <Switch defaultChecked />
              </Form.Item>
            </Col>
          </Row>
    ...
    <>
      <Section title="Return Policies">
        <Form layout="vertical">
          <Row gutter={[16, 0]}>
            <Col xs={24} sm={12}>
              <Form.Item label="Allow sales returns" style={{ marginBottom: 16 }}>
                <Switch defaultChecked />
              </Form.Item>
            </Col>
            <Col xs={24} sm={12}>
              <Form.Item label="Return window (days)" style={{ marginBottom: 16 }}>
                <InputNumber defaultValue={30} min={0} style={{ width: "100%" }} addonAfter="days" />
              </Form.Item>
            </Col>
            <Col xs={24} sm={12}>
            ...
            <Col xs={24} sm={12}>
              <Form.Item label="Refund method" style={{ marginBottom: 16 }}>
                <Select defaultValue="credit" options={[
            ...
            <Col xs={24} sm={12}>
              <Form.Item label="Restock returned items" style={{ marginBottom: 16 }}>
                <Switch defaultChecked />
              </Form.Item>
            </Col>
          </Row>
            ...
            <Col xs={24} sm={12}>
              <Form.Item label="Tax calculation" style={{ marginBottom: 16 }}>
                <Radio.Group defaultValue="exclusive">
                  <Space>
                    <Radio value="exclusive">Tax exclusive (added on top)</Radio>
                    <Radio value="inclusive">Tax inclusive (included in price)</Radio>
                  </Space>
                </Radio.Group>
              </Form.Item>
            </Col>
            <Col xs={24} sm={12}>
              <Form.Item label="Show tax breakdown on invoice" style={{ marginBottom: 16 }}>
                <Switch defaultChecked />
              </Form.Item>
            </Col>
            <Col xs={24} sm={12}>
              <Form.Item label="Apply tax to shipping" style={{ marginBottom: 16 }}>
                <Switch defaultChecked />
              </Form.Item>
            </Col>
          </Row>
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
      <div style={{ display: "flex", alignItems: "center", gap: 14 }}>
        ...
        <div>
          <Title level={5} style={{ margin: 0 }}>Sales Settings</Title>
          <Text type="secondary" style={{ fontSize: 12 }}>Configure invoicing, pricing, discounts, and sales policies</Text>
        </div>
      </div>
