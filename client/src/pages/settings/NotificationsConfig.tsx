...
const NOTIF_CATEGORIES = [
  ...
  {
    module: "System",
    items: ["Backup completed", "Login from new device", "User role changed"],
  },
];
...
const ESCALATION_RULES = [
  {
    ...
    level1: "Account Manager (2hrs)",
    level2: "Finance Manager (24hrs)",
    level3: "Director (48hrs)",
  },
  {
    key: "2",
    trigger: "Critical stock level reached",
    level1: "Warehouse Staff (1hr)",
    level2: "Operations Manager (4hrs)",
    level3: "— ",
  },
  {
    key: "3",
    trigger: "Failed login attempts > 5",
    level1: "IT Admin (immediate)",
    level2: "Security Officer (1hr)",
    level3: "— ",
  },
];
...
function AlertTypesTab() {
  ...
  return (
    <>
      ...
      >
        <Text type="secondary" style={{ fontSize: 12 }}>
          Configure channels and recipients per alert type
        </Text>
...
function EscalationTab() {
  ...
  return (
    <>
      ...
      >
        <Text type="secondary" style={{ fontSize: 12 }}>
          Define auto-escalation rules when alerts go unacknowledged
        </Text>
        <Button type="primary" icon={<PlusOutlined />} size="small">
          New Rule
        </Button>
      ...
      {ESCALATION_RULES.map(rule => (
        ...
        >
          ...
          <div style={{ display: "flex", gap: 16, flexWrap: "wrap" }}>
            {[
              { label: "Level 1", value: rule.level1 },
              { label: "Level 2", value: rule.level2 },
              { label: "Level 3", value: rule.level3 },
            ].map(l => (
              <div
                key={l.label}
                style={{
...
function AnnouncementsTab() {
  return (
    <>
      <Section
        title="Internal Announcement Settings"
        description="Control how company-wide announcements are broadcast"
      >
        <Form layout="vertical">
          <Row gutter={[16, 0]}>
            ...
            <Col xs={24} sm={12}>
              <Form.Item
                label="Announcement Retention (days)"
                style={{ marginBottom: 16 }}
              >
                <Select
                  defaultValue="30"
                  options={["7", "14", "30", "60", "90"].map(v => ({
                    value: v,
                    label: `${v} days`,
                  }))}
                />
            ...
            <Col xs={24}>
              <Form.Item
                label="Who Can Send Announcements"
                style={{ marginBottom: 16 }}
              >
                <Select
                  mode="multiple"
      ...
      <div style={{ display: "flex", justifyContent: "flex-end" }}>
        <Button
          type="primary"
          icon={<SaveOutlined />}
          onClick={() => message.success("Announcement settings saved")}
        >
          Save Settings
        </Button>
      </div>
    ...
    <>
      <Section title="Notification Language Settings">
        <Form layout="vertical">
              ...
              <Form.Item label="User Override" style={{ marginBottom: 16 }}>
                <Select
                  ...
                  options={[
                    {
                      value: "allowed",
                      label: "Allow users to set their own language",
                    },
                    {
                      value: "forced",
                      label: "Force default language for all users",
                    },
                  ]}
                />
              </Form.Item>
          ...
          >
            Notification Type Language Override
          </Text>
          <List
            dataSource={[
      ...
      <div style={{ display: "flex", justifyContent: "flex-end" }}>
        <Button
          type="primary"
          icon={<SaveOutlined />}
          onClick={() => message.success("Language settings saved")}
        >
          Save Settings
        </Button>
      </div>
...
function QuietHoursTab() {
  ...
  return (
    <>
      <Section
        title="Quiet Hours"
        description="No non-critical notifications will be sent during these hours"
      ...
      <div style={{ display: "flex", justifyContent: "flex-end" }}>
        <Button
          type="primary"
          icon={<SaveOutlined />}
          onClick={() => message.success("Quiet hours saved")}
        >
          Save Settings
        </Button>
      </div>
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
        <div style={{ display: "flex", alignItems: "center", gap: 14 }}>
          ...
          <div>
            ...
            <Text type="secondary" style={{ fontSize: 12 }}>
              Configure how and when your team receives alerts and notifications
            </Text>
          </div>
        </div>
