...
import {
  Alert, Button, Card, Col, Form, Input, InputNumber, Radio,
  Row, Select, Space, Switch, Tag, Typography, message, theme as antTheme,
} from "antd";
import {
  AppstoreOutlined, BarChartOutlined, BarcodeOutlined, ControlOutlined,
  HomeOutlined, InboxOutlined, SaveOutlined, SettingOutlined,
    ...
    <>
      <Section title="Default Settings">
        <Form layout="vertical">
          <Row gutter={[16, 0]}>
            <Col xs={24} sm={12}>
              <Form.Item label="Default Unit of Measure" style={{ marginBottom: 16 }}>
                <Select defaultValue="pcs" options={[
            ...
            <Col xs={24} sm={12}>
              <Form.Item label="Default Product Type" style={{ marginBottom: 16 }}>
                <Select defaultValue="storable" options={[
      ...
      <Section title="Product Catalog">
        <Form layout="vertical">
          <Row gutter={[16, 0]}>
            <Col xs={24} sm={12}>
              <Form.Item label="Show product images in lists" style={{ marginBottom: 16 }}>
                <Switch defaultChecked />
              </Form.Item>
            </Col>
            <Col xs={24} sm={12}>
              <Form.Item label="Enable product variants" style={{ marginBottom: 16 }}>
                <Switch defaultChecked />
              </Form.Item>
            </Col>
            <Col xs={24} sm={12}>
              <Form.Item label="Enable serial number tracking" style={{ marginBottom: 16 }}>
                <Switch />
              </Form.Item>
            </Col>
            <Col xs={24} sm={12}>
              <Form.Item label="Enable lot / batch tracking" style={{ marginBottom: 0 }}>
                <Switch />
              </Form.Item>
            </Col>
          </Row>
              ...
              <Space direction="vertical" size={14}>
                <Radio value="fifo">
                  ...
                  <Text type="secondary" style={{ fontSize: 12 }}>
                    Cost of oldest inventory is used first. Best for perishable or time-sensitive goods.
                  </Text>
                </Radio>
                <Radio value="avg">
                  ...
                  <br />
                  <Text type="secondary" style={{ fontSize: 12 }}>
                    Cost is averaged across all units. Simple and common for most businesses.
                  </Text>
                </Radio>
                <Radio value="lifo">
                  ...
                  <br />
                  <Text type="secondary" style={{ fontSize: 12 }}>
                    Cost of newest inventory is used first. Not allowed under IFRS.
                  </Text>
                </Radio>
                <Radio value="standard">
                  ...
                  <br />
                  <Text type="secondary" style={{ fontSize: 12 }}>
                    A predefined cost is set manually and used consistently. Variances are posted to accounts.
                  </Text>
                </Radio>
              </Space>
            </Radio.Group>
          </Form.Item>
          <Form.Item label="Include Landed Costs in Product Cost" style={{ marginBottom: 16 }}>
            <Switch defaultChecked />
          </Form.Item>
          <Form.Item label="Revaluation on Currency Change" style={{ marginBottom: 0 }}>
            <Switch />
          </Form.Item>
        </Form>
      </Section>
          ...
          <Row gutter={[16, 0]}>
            <Col xs={24} sm={12}>
              <Form.Item label="Inventory Account" style={{ marginBottom: 16 }}>
                <Select defaultValue="1300" options={[
            ...
            <Col xs={24} sm={12}>
              <Form.Item label="COGS Account" style={{ marginBottom: 16 }}>
                <Select defaultValue="5100" options={[
    ...
    <>
      <Section title="Product Numbering">
        <Form layout="vertical">
          <Row gutter={[16, 0]}>
            <Col xs={24} sm={12}>
              <Form.Item label="Auto-generate Product Code" style={{ marginBottom: 16 }}>
                <Switch defaultChecked />
              </Form.Item>
            </Col>
            <Col xs={24} sm={12}>
              <Form.Item label="Product Code Prefix" style={{ marginBottom: 16 }}>
                <Input defaultValue="PRD-" maxLength={10} />
              </Form.Item>
            </Col>
            <Col xs={24} sm={12}>
              <Form.Item label="Next Sequence Number" style={{ marginBottom: 16 }}>
                <InputNumber defaultValue={1001} min={1} style={{ width: "100%" }} />
              </Form.Item>
            </Col>
            <Col xs={24} sm={12}>
              <Form.Item label="Padding (digits)" style={{ marginBottom: 16 }}>
                <Select defaultValue={4} options={[3,4,5,6].map(v => ({ value: v, label: `${v} digits (e.g. ${String(1).padStart(v, "0")})` }))} />
              </Form.Item>
            </Col>
          </Row>
        </Form>
          ...
          <Row gutter={[16, 0]}>
            <Col xs={24} sm={12}>
              <Form.Item label="Barcode Type" style={{ marginBottom: 16 }}>
                <Select defaultValue="ean13" options={[
            ...
            <Col xs={24} sm={12}>
              <Form.Item label="Auto-generate Barcode" style={{ marginBottom: 16 }}>
                <Switch defaultChecked />
              </Form.Item>
            </Col>
          </Row>
    ...
    <>
      <Section title="Stock Policies">
        <Form layout="vertical">
          <Row gutter={[16, 0]}>
            <Col xs={24} sm={12}>
              <Form.Item label="Allow Negative Stock" style={{ marginBottom: 16 }}>
                <Switch />
              </Form.Item>
            </Col>
            <Col xs={24} sm={12}>
              <Form.Item label="Auto-deduct stock on invoice" style={{ marginBottom: 16 }}>
                <Switch defaultChecked />
              </Form.Item>
            </Col>
            <Col xs={24} sm={12}>
              <Form.Item label="Auto-replenishment (reorder rules)" style={{ marginBottom: 16 }}>
                <Switch defaultChecked />
              </Form.Item>
            </Col>
            <Col xs={24} sm={12}>
              <Form.Item label="Require quality check before receiving" style={{ marginBottom: 16 }}>
                <Switch />
              </Form.Item>
            </Col>
          </Row>
      ...
      <Section title="Reorder Defaults">
        <Form layout="vertical">
          <Row gutter={[16, 0]}>
            <Col xs={24} sm={12}>
              <Form.Item label="Default Reorder Point (units)" style={{ marginBottom: 16 }}>
                <InputNumber defaultValue={10} min={0} style={{ width: "100%" }} />
              </Form.Item>
            </Col>
            <Col xs={24} sm={12}>
              <Form.Item label="Default Reorder Quantity (units)" style={{ marginBottom: 16 }}>
                <InputNumber defaultValue={50} min={1} style={{ width: "100%" }} />
              </Form.Item>
            </Col>
            <Col xs={24} sm={12}>
              <Form.Item label="Lead Time (days)" style={{ marginBottom: 16 }}>
                <InputNumber defaultValue={7} min={0} style={{ width: "100%" }} />
              </Form.Item>
            </Col>
            <Col xs={24} sm={12}>
              <Form.Item label="Safety Stock (units)" style={{ marginBottom: 16 }}>
                <InputNumber defaultValue={5} min={0} style={{ width: "100%" }} />
              </Form.Item>
            </Col>
          </Row>
        </Form>
      ...
      <Section title="Warehouse Defaults">
        <Form layout="vertical">
          <Row gutter={[16, 0]}>
            ...
            <Col xs={24} sm={12}>
              <Form.Item label="Multi-warehouse Mode" style={{ marginBottom: 16 }}>
                <Switch defaultChecked />
              </Form.Item>
            </Col>
            <Col xs={24} sm={12}>
              <Form.Item label="Enable bin / location tracking" style={{ marginBottom: 16 }}>
                <Switch />
              </Form.Item>
            </Col>
            <Col xs={24} sm={12}>
              <Form.Item label="Require approval for warehouse creation" style={{ marginBottom: 16 }}>
                <Switch />
              </Form.Item>
            </Col>
          </Row>
      ...
      <Section title="Transfer Policies">
        <Form layout="vertical">
          <Row gutter={[16, 0]}>
            ...
            <Col xs={24} sm={12}>
              <Form.Item label="Allow partial transfers" style={{ marginBottom: 16 }}>
                <Switch defaultChecked />
              </Form.Item>
            </Col>
            <Col xs={24} sm={12}>
              <Form.Item label="Auto-validate transfers" style={{ marginBottom: 16 }}>
                <Switch />
              </Form.Item>
            </Col>
            <Col xs={24} sm={12}>
      ...
      <Section title="Stock Alerts">
        <Form layout="vertical">
          <Row gutter={[16, 0]}>
            ...
            <Col xs={24} sm={12}>
              <Form.Item label="Low Stock Threshold (units)" style={{ marginBottom: 16 }}>
                <InputNumber defaultValue={10} min={0} style={{ width: "100%" }} />
              </Form.Item>
            </Col>
            <Col xs={24} sm={12}>
              <Form.Item label="Out-of-Stock Alert" style={{ marginBottom: 16 }}>
                <Switch defaultChecked />
              </Form.Item>
            </Col>
            <Col xs={24} sm={12}>
            ...
            <Col xs={24} sm={12}>
              <Form.Item label="Expiry Date Alert (days before)" style={{ marginBottom: 16 }}>
                <InputNumber defaultValue={30} min={0} style={{ width: "100%" }} addonAfter="days" />
              </Form.Item>
            </Col>
            <Col xs={24} sm={12}>
              <Form.Item label="Alert Notification Channel" style={{ marginBottom: 16 }}>
                <Select defaultValue="email" mode="multiple" options={[
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
      <div style={{ display: "flex", alignItems: "center", gap: 14 }}>
        ...
        <div>
          <Title level={5} style={{ margin: 0 }}>Inventory Settings</Title>
          <Text type="secondary" style={{ fontSize: 12 }}>Configure stock management, costing methods, warehouses, and alerts</Text>
        </div>
      </div>
