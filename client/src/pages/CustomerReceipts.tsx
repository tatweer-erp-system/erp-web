...
export default function CustomerReceipts() {
  ...
  const createMutation = useMutation({
    ...
    onSuccess: () => {
      notification.success({
        message: t("payments.receipts.created", lang),
      });
      invalidate();
      closeModal();
    },
  ...
  const postMutation = useMutation({
    ...
    onSuccess: () => {
      notification.success({
        message: t("payments.receipts.posted", lang),
      });
      invalidate();
      setDrawerOpen(false);
      setViewPayment(null);
  ...
  const cancelMutation = useMutation({
    ...
    onSuccess: () => {
      notification.success({
        message: t("payments.receipts.cancelled", lang),
      });
      invalidate();
      setDrawerOpen(false);
      setViewPayment(null);
  ...
  const columns: TableColumnsType<Payment> = [
    ...
    },
    {
      ...
      width: 60,
      render: (_, rec) => (
        <Tooltip title={t("payments.receipts.view", lang)}>
          <Button
            type="text"
            icon={<EyeOutlined />}
      ...
      <Space direction="vertical" size={20} style={{ width: "100%" }}>
        ...
        <Card size="small" styles={{ body: { padding: "12px 16px" } }}>
          ...
          >
            <Space wrap>
              <Input.Search
                placeholder={t("payments.receipts.search", lang)}
                value={searchText}
            ...
            <Space>
              <Tooltip title={t("payments.receipts.reload", lang)}>
                <Button
                  icon={<ReloadOutlined />}
        ...
        <Card styles={{ body: { padding: 0 } }}>
          <Table
            ...
            locale={{
              emptyText: t("payments.receipts.noData", lang),
            }}
          />
        </Card>
      </Space>
