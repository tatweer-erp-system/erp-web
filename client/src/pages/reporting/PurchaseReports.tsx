 ...
 * Fetches purchase breakdown from GET /reporting/sales (purchase orders)
 * and displays KPI cards, bar chart by status, and a detail table.
 */
...
export default function PurchaseReports() {
  ...
  // ── Table columns ──────────────────────────────────────────────────────────
  const columns: TableColumnsType<PurchaseReportRow> = useMemo(
    () => [
      {
      ...
      },
      {
        ...
        width: 140,
        align: "end" as const,
        sorter: (a: PurchaseReportRow, b: PurchaseReportRow) =>
        ...
        >
          <div>
            <Title level={4} style={{ margin: 0 }}>
              {t("purchaseReports.title", lang)}
            </Title>
            <Text type="secondary" style={{ fontSize: 13 }}>
              {t("purchaseReports.subtitle", lang)}
            </Text>
          </div>
          <Space wrap>
            <RangePicker
